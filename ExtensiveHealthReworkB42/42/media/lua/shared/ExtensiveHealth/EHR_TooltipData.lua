...
EHR.Tooltips.Data = {
    ...
    ["ExtensiveHealth.ColdFluTablets"] = {
        ...
        tier = 1,
        description = "Over-the-counter cold and flu relief tablets.",
    ...
    ["ExtensiveHealth.AntifungalTablets"] = {
        ...
        effects = {"CURES corpse exposure illness"},
    },
    ...
    ["ExtensiveHealth.BroadSpectrumAntibiotics"] = {
        ...
        cures = {"Multiple bacterial infections", "Sepsis"},
        treatmentTime = "72 hours",
    ...
    ["ExtensiveHealth.CorticosteroidInjection"] = {
        ...
        cures = {"Severe inflammation", "Corpse Sickness"},
        treatmentTime = "24 hours (FAST)",
        effects = {"FAST CURE for inflammation-related illness"},
    ...
    ["ExtensiveHealth.IVAmphotericin"] = {
        ...
        cures = {"Severe Corpse Sickness"},
        treatmentTime = "48 hours (FAST)",
        effects = {"FAST CURE for severe corpse exposure illness"},
    ...
    ["ExtensiveHealth.ChelationKit"] = {
        ...
        cures = {"Corpse Sickness"},
        treatmentTime = "48 hours (FAST)",
        effects = {"FAST CURE for corpse exposure illness"},
    ...
    ["ExtensiveHealth.IVCiprofloxacin"] = {
        ...
        cures = {"Gastroenteritis", "Dysentery", "Bacterial GI infections"},
        treatmentTime = "24 hours (FAST)",
        effects = {"FAST CURE for GI infections"},
